...
def important_functions():
    ...
    print("List after appending 6: ", list1.append(6))
    print("List after removing 6: ", list1.remove(6))
    print("List after inserting 6 at index 2: ", list1.insert(2, 6))
    print("List after popping element at index 2: ", list1.pop(2))
    print("List after extending [7, 8, 9]: ", list1.extend([7, 8, 9]))
    print("List after clearing: ", list1.clear())
    print("List after copying: ", list1.copy())
